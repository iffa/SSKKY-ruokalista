...
package email.crappy.ssao.ruoka.mvp.fixed;
 ...
 * @since 1.0.0
 */
public abstract class MvpLceFragmentFixed<CV extends View, M, V extends MvpLceView<M>, P extends MvpPresenter<V>>
    ...
    protected void animateContentViewIn() {
        LceAnimatorFixed.showContent(loadingView, contentView, errorView);
    }
