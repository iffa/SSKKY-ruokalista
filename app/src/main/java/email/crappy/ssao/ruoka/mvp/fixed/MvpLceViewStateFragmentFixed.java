 ...
 * @since 1.0.0
 */
public abstract class MvpLceViewStateFragmentFixed<CV extends View, M, V extends MvpLceView<M>, P extends MvpPresenter<V>>
        extends MvpLceFragmentFixed<CV, M, V, P> implements MvpLceView<M>,
